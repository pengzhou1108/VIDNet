...
def get_parser():
    ...
    parser.add_argument('-base_model', dest='base_model', default = 'resnet101',
                        choices=['resnet101','resnet50','resnet34','vgg16','vgg16_bn','unet'])
    ...
    parser.add_argument('--use_segment', dest='use_segment', action='store_true')
    parser.set_defaults(use_segment=False)
    parser.add_argument('-segment_name', dest='segment_name', default='zero-shot-model-davis')
